        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="card-hover border-0 shadow-modern bg-gradient-to-br from-blue-50 to-indigo-100">
            <CardContent className="p-8 text-center relative overflow-hidden">
              ...
              <p className="text-gray-600">Excellence in progress! 🌟</p>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-8 relative overflow-hidden">
              ...
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Algebra • Advanced</p>
                </div>
              </div>
              <Progress value={0} className="mb-4 progress-modern" />
              <p className="text-sm text-gray-600 mb-6">Ready to excel in this topic!</p>
          ...
          <Card className="card-hover border-0 shadow-modern bg-gradient-to-br from-purple-50 to-pink-100">
            <CardContent className="p-8 relative overflow-hidden">
              ...
              <h3 className="text-xl font-bold mb-6 text-gray-900">WASSCE Readiness</h3>
              <div className="flex items-center mb-6">
              ...
              <div className="bg-white/50 border border-purple-200 rounded-xl p-4 mb-6">
                <p className="text-sm text-purple-900 font-medium">
                  <span className="font-medium">Ready to start?</span> Take your first practice test!
                </p>
              </div>
              <Button variant="outline" className="w-full border-2 border-purple-500 text-purple-600 hover:bg-purple-50 rounded-xl font-semibold">
                <TrendingUp className="w-4 h-4 mr-2" />
                Take WASSCE Practice Test
              </Button>
            </CardContent>
          </Card>
        </div>
